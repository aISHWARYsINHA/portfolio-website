...
const projects = [
  {
    ...
    description: "Modern online shopping experience with cart management, product filtering, and secure checkout flow.",
  ...
  },
  {
    ...
    description: "Collaborative productivity tool with kanban boards, real-time updates, and team workflows.",
  ...
  },
  {
    ...
    tags: ["React Native", "API", "Maps", "Animations"],
    demoUrl: "https://demo.example.com",
    githubUrl: "https://github.com/example/weather",
  },
  {
    title: "Analytics Dashboard",
    description: "Data visualization platform with real-time metrics, customizable charts, and export capabilities.",
    image: analyticsImage,
    tags: ["React", "D3.js", "Charts", "TypeScript"],
    demoUrl: "https://demo.example.com",
    githubUrl: "https://github.com/example/analytics",
  },
  {
    title: "Recipe Platform",
    description: "Social recipe sharing community with search, collections, and step-by-step cooking guides.",
    image: recipeImage,
    tags: ["React", "Firebase", "Search", "Images"],
    demoUrl: "https://demo.example.com",
    githubUrl: "https://github.com/example/recipes",
  },
  {
    title: "Fitness Tracker",
    description: "Comprehensive health and fitness app with workout logging, progress tracking, and goal setting.",
    image: fitnessImage,
    tags: ["React Native", "Health APIs", "Charts", "Mobile"],
    demoUrl: "https://demo.example.com",
